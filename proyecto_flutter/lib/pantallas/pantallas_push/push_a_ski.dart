...
class PushASki extends StatefulWidget {
  const PushASki({Key? key, required this.titulo, required this.texto}) : super(key: key);
  final String titulo;
  final String texto;


  @override
  State<PushASki> createState() => _PushASkiState();
}

class _PushASkiState extends State<PushASki> {
