...
class TextoPushASurf extends StatefulWidget {
  const TextoPushASurf({Key? key}) : super(key: key);

  @override
  State<TextoPushASurf> createState() => _TextoPushASurfState();
}

class _TextoPushASurfState extends State<TextoPushASurf> {
                  ...
                  if(titulo.isEmpty){
                    ...
                    if(texto.isEmpty){
                      ...
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => PushAASurf(titulo: titulo,texto: texto,), //#0006
                          ));
                    }
                  }
