...
class PushAASkate extends StatefulWidget {
  const PushAASkate({Key? key, required this.titulo, required this.texto}) : super(key: key);
  final String titulo;
  final String texto;


  @override
  State<PushAASkate> createState() => _PushAASkateState();
}

class _PushAASkateState extends State<PushAASkate> {
