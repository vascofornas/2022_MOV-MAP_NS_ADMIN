...
class PushABMX extends StatefulWidget {
  const PushABMX({Key? key, required this.titulo, required this.texto}) : super(key: key);
  final String titulo;
  final String texto;


  @override
  State<PushABMX> createState() => _PushABMXState();
}

class _PushABMXState extends State<PushABMX> {
