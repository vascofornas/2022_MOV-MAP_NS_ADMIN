...
class PushAMoto extends StatefulWidget {
  const PushAMoto({Key? key, required this.titulo, required this.texto}) : super(key: key);
  final String titulo;
  final String texto;


  @override
  State<PushAMoto> createState() => _PushAMotoState();
}

class _PushAMotoState extends State<PushAMoto> {
