...
import 'package:movmap_ns_admin/pantallas/pantallas_push/push_a_para.dart';
...
class TextoPushAPara extends StatefulWidget {
  const TextoPushAPara({Key? key}) : super(key: key);

  @override
  State<TextoPushAPara> createState() => _TextoPushAParaState();
}

class _TextoPushAParaState extends State<TextoPushAPara> {
                  ...
                  if(titulo.isEmpty){
                    ...
                    if(texto.isEmpty){
                      ...
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => PushAPara(titulo: titulo,texto: texto,), //#0006
                          ));
                    }
                  }
