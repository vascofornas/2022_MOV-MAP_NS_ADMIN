...
class PushAASurf extends StatefulWidget {
  const PushAASurf({Key? key, required this.titulo, required this.texto}) : super(key: key);
  final String titulo;
  final String texto;


  @override
  State<PushAASurf> createState() => _PushAASurfState();
}

class _PushAASurfState extends State<PushAASurf> {
