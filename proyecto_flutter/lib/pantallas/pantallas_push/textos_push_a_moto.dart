...
class TextoPushAMoto extends StatefulWidget {
  const TextoPushAMoto({Key? key}) : super(key: key);

  @override
  State<TextoPushAMoto> createState() => _TextoPushAMotoState();
}

class _TextoPushAMotoState extends State<TextoPushAMoto> {
                  ...
                  if(titulo.isEmpty){
                    ...
                    if(texto.isEmpty){
                      ...
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => PushAMoto(titulo: titulo,texto: texto,), //#0006
                          ));
                    }
                  }
