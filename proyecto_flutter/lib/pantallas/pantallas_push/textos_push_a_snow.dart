...
class TextoPushASnow extends StatefulWidget {
  const TextoPushASnow({Key? key}) : super(key: key);

  @override
  State<TextoPushASnow> createState() => _TextoPushASnowState();
}

class _TextoPushASnowState extends State<TextoPushASnow> {
                  ...
                  if(titulo.isEmpty){
                    ...
                    if(texto.isEmpty){
                      ...
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => PushASnow(titulo: titulo,texto: texto,), //#0006
                          ));
                    }
                  }
