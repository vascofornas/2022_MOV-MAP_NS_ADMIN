...
class TextoPushABMX extends StatefulWidget {
  const TextoPushABMX({Key? key}) : super(key: key);

  @override
  State<TextoPushABMX> createState() => _TextoPushABMXState();
}

class _TextoPushABMXState extends State<TextoPushABMX> {
                  ...
                  if(titulo.isEmpty){
                    ...
                    if(texto.isEmpty){
                      ...
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => PushABMX(titulo: titulo,texto: texto,), //#0006
                          ));
                    }
                  }
