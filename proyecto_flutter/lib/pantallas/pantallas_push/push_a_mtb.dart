...
class PushAMTB extends StatefulWidget {
  const PushAMTB({Key? key, required this.titulo, required this.texto}) : super(key: key);
  final String titulo;
  final String texto;


  @override
  State<PushAMTB> createState() => _PushAMTBState();
}

class _PushAMTBState extends State<PushAMTB> {
