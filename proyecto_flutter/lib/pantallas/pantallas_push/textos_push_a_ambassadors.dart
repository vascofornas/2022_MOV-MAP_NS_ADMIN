...
class TextoPushAAmbassadors extends StatefulWidget {
  const TextoPushAAmbassadors({Key? key}) : super(key: key);

  @override
  State<TextoPushAAmbassadors> createState() => _TextoPushAAmbassadorsState();
}

class _TextoPushAAmbassadorsState extends State<TextoPushAAmbassadors> {
                  ...
                  if(titulo.isEmpty){
                    ...
                    if(texto.isEmpty){
                      ...
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => PushAAmbassadors(titulo: titulo,texto: texto,), //#0006
                          ));
                    }
                  }
