...
class TextoPushAMTB extends StatefulWidget {
  const TextoPushAMTB({Key? key}) : super(key: key);

  @override
  State<TextoPushAMTB> createState() => _TextoPushAMTBState();
}

class _TextoPushAMTBState extends State<TextoPushAMTB> {
                  ...
                  if(titulo.isEmpty){
                    ...
                    if(texto.isEmpty){
                      ...
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => PushAMTB(titulo: titulo,texto: texto,), //#0006
                          ));
                    }
                  }
